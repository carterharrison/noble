...
Hci.prototype.stop = function () {
  ...
  // this is where we can stop the hci socket
  this._socket.stop()
}
...
Hci.prototype.init = function() {
  ...
  //    // THIS IS WHERE THE SOCKET STARTS
  //   this._socket.start();
...
Hci.prototype.onSocketData = function(data) {
  debug('onSocketData noble: ' + data.toString('hex'));
