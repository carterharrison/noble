...
Noble.prototype.enable = function() {
  // check if the bindings can start, will return true if they can
  if (this._bindings.hasOwnProperty("start")) {
...
Noble.prototype.disable = function() {
  // check if the bindings can stop, will return true if they can
  if (this._bindings.hasOwnProperty("stop")) {
    this._bindings.stop()
    return true
  }
